        ...
        <form onSubmit={handleLogin} className="bg-[#141414] rounded-xl border border-[#2e2e2e] p-6 space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-sm font-medium text-[#ccc]">Password</label>
              <Link href="/forgot-password" className="text-xs text-[#555] hover:text-[#ff3c00] transition-colors">
                Forgot password?
              </Link>
            </div>
            <input
